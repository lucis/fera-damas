...
<div id="a4">
    ...
    <div id="title">
        ...
        ?>
        <?php echo $vetor[1];?>ª série <?php echo strtoupper($vetor[2]);?> - E-mail dos alunos
    </div>
    <table border="1" width="1000px" cellspacing=0 cellpadding=2 style="font-family: 'Trebuchet MS'; font-variant: small-caps;">
        ...
        while ($loop = mysql_fetch_array($listagem, MYSQL_ASSOC)) {
            ...
            <tr>
                ...
                <td width="37%"><a target="_blank" style="text-transform: uppercase; text-decoration: none; " href="../aluno.php?aluno=<?php echo $loop['id'];?>"><?php echo utf8_encode($loop['nome']); ?></a></td>
