...
<div id="a4">
    ...
    <div id="title">
        ...
        ?>
        <?php echo $vetor[1];?>ª série <?php echo strtoupper($vetor[2]);?> - Inglês
    </div>
    <table border="1" width="1000px" cellspacing=0 cellpadding=2 style="font-family: 'Trebuchet MS'; font-variant: small-caps;">
        ...
        <?php
        $listagem = mysql_query("SELECT * FROM alunos WHERE serie = '$turma' AND lingua = '1' ORDER BY num") or die(mysql_error());
