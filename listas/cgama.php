...
<div id="a4">
    ...
    <div id="title">
        ...
        ?>
        <?php echo $vetor[1];?>ª série <?php echo strtoupper($vetor[2]);?> por ordem alfabética
    </div>
    <table border="1" width="1000px" cellspacing=0 cellpadding=2 style="font-family: 'Trebuchet MS'; font-variant: small-caps;">
        <tr>
            ...
            <th align="left">C-GAMA</th>
            <th ALIGN="left">NOME</th>
        </tr>
        <?php
            $listagem = mysql_query("SELECT * FROM alunos WHERE serie = '$turma' ORDER BY nome") or die(mysql_error());
            while ($loop = mysql_fetch_array($listagem, MYSQL_ASSOC)) {
                ?>
                <tr>
                    <td width="5%"><?php echo $loop['num'] ; ?></td>
                    <td width="10%"><?php echo $loop['id']; ?></td>
