            ...
            <div class="bloco"><input type="text" id="nome" name="nome" value="<?php echo $nome; ?>">
                <select id="turma" name="turma">
                    ...
                    while ($single = mysql_fetch_array($turmas, MYSQL_ASSOC)){
                        ...
                        $sele = $ids == $serie ? "selected" : "";
                        ?>
                        <option value="<?php echo $ids; ?>" <?php echo $sele; ?>><?php echo $series; ?>&ordm; série <?php echo $turmaa; ?></option>
                    <?php
                    }
                    ?>
                ...
                <div class="titulo">
                    <div style=" width: 450px; float: left; ">
                        ...
                        <select id="parentesco1" name="parentesco1">
                            ...
                            ?>
                            <option value="mãe" <?php parentesco($parentesco1, "mãe"); ?>>mãe</option>
                            <option value="pai" <?php parentesco($parentesco1, "pai"); ?>>pai</option>
                            <option value="tio" <?php parentesco($parentesco1, "tio"); ?>>tio</option>
                            <option value="tia" <?php parentesco($parentesco1, "tia"); ?>>tia</option>
                            <option value="avó" <?php parentesco($parentesco1, "avó"); ?>>avó</option>
                            <option value="avô" <?php parentesco($parentesco1, "avô"); ?>>avô</option>
                            <option value="primo" <?php parentesco($parentesco1, "primo"); ?>>primo</option>
                            <option value="outro" <?php parentesco($parentesco1, "outro"); ?>>outro</option>
                        </select>
                    </div>
                ...
                <div class="titulo">
                    <div style=" width: 450px; float: left; ">
                        ...
                        <select id="parentesco2" name="parentesco2">
                            <option value="mãe" <?php parentesco($parentesco2, "mãe"); ?>>mãe</option>
                            <option value="pai" <?php parentesco($parentesco2, "pai"); ?>>pai</option>
                            <option value="tio" <?php parentesco($parentesco2, "tio"); ?>>tio</option>
                            <option value="tia" <?php parentesco($parentesco2, "tia"); ?>>tia</option>
                            <option value="avó" <?php parentesco($parentesco2, "avó"); ?>>avó</option>
                            <option value="avô" <?php parentesco($parentesco2, "avô"); ?>>avô</option>
                            <option value="primo" <?php parentesco($parentesco2, "primo"); ?>>primo</option>
                            <option value="outro" <?php parentesco($parentesco2, "outro"); ?>>outro</option>
                        </select>
                    </div>
                    <div style=" float: right;  margin-right: 116px;">Celular(1)</div>
                </div>
            ...
            <div class="bloco">
                ...
                <div id="lingua">
                    <select name="lingua">
                        ...
                        <option value="1" <?php $es = ""; if ($lingua == "1") { echo "selected"; } else {$es = "selected";}?>>Inglês</option>
                        <option value="2" <?php echo $es; ?>>Espanhol</option>
                    </select></div></div>
        </div>
